...
Functions and tools rust with zsh
...
2. Clone the plugin
   ``bash   git clone https://github.com/luismayta/zsh-rust``\ bash
3. Edit your ``.zshrc`` and add
   ``plugins=( ... zsh-rust )`` to your list of
   plugins
...
.. |Build Status| image:: https://travis-ci.org/luismayta/zsh-rust.svg
   :target: https://travis-ci.org/luismayta/zsh-rust
.. |GitHub issues| image:: https://img.shields.io/github/issues/luismayta/zsh-rust.svg
   :target: https://github.com/luismayta/zsh-rust/issues
