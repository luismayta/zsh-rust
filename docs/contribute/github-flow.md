<!-- Space: Projects -->
<!-- Parent: ZshRust -->
<!-- Title: Contributing GithubFlow ZshRust -->
<!-- Label: ZshRust -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to zsh-rust project on [GitHub](https://github.com/luismayta/zsh-rust), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/luismayta/zsh-rust/pulls).
...
To follow the instructions in this guide and start contributing to zsh-rust project on GitHub:
...
```bash
git remote add upstream  https://github.com/luismayta/zsh-rust.git
```

Now your **upstream** points to **luismayta/zsh-rust**.
...
git fetch upstream # assuming upstream is luismayta/zsh-rust
...
All merge requests are automatically tested using [Github Actions](https://github.com/luismayta/zsh-rust/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
